...
# 🔍 Methodology
Data Preparation
Temporal Alignment: Trade timestamps (IST) were normalized to daily grains to join with the Crypto Fear & Greed Index.
...
Whales: Top 25th percentile by average position size.

Frequent Retail: High trade frequency (>10 trades/day) but smaller sizes.

Occasional Retail: Low frequency, small size participants.
